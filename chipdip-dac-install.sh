...
cp /volumio/ChipDipDACs/./chipdip-dac-driver_v1 /volumio/app/plugins/system_controller/i2s_dacs/scripts/./chipdip-dac-driver_v1
cp /volumio/ChipDipDACs/chipdip-dac-init.sh /volumio/app/plugins/system_controller/i2s_dacs/scripts/chipdip-dac-init.sh
chmod +x /volumio/app/plugins/system_controller/i2s_dacs/scripts/./chipdip-dac-driver_v1
